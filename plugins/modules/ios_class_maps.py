        ...
        suboptions:
            ...
            matches:
                ...
                suboptions:
                    ...
                    protocol:
                        description:
                            - Configure Network-Based Application Recognition (NBAR)
                                to match traffic by a protocol (and subprotcol options) that is known to NBAR.
    ...
    running_config:
        description:
            ...
            - The value of this option should be the output received from
                the IOS device by executing the command B(show running part class-map).
